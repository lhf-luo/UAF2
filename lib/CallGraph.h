...
class CallGraphPass : public IterativeModulePass {
	...
	private:
		...
		static std::map<std::string, std::vector<StructType*>> StructGroups;
		...
		bool FindCalleesWithSMLTA(CallInst *CI, FuncSet &FS);
		...
		bool IsDegradedType(Type* Ty);
		void constructStruct();
		bool IsDegradedStructType(StructType* STy);
		bool analyzeBitCast(BitCastInst *BC);
